...
#include <filesystem>
int main(){
 auto source=std::make_shared<scene::CastScene>(scene::buildScene(cast::Document::load(cadence::local_assets::exportPath("bo2/models/playermodels/isa/c_usa_mp_isa_smg_fb/c_usa_mp_isa_smg_fb_LOD0.cast")),false));
 scene::appendAnimations(cast::Document::load(cadence::local_assets::exportPath("bo2/animations/pb/stand/pistol/pb_stand_alert_pistol.cast")),*source);
 ...
 const std::filesystem::path root=cadence::local_assets::exportPath("codm/models");
