...
int main(){
 ...
 for(auto hand:{"viewmodel_SWAT_Male_hands","c_usa_mp_isa_smg_viewhands_LOD0"})for(auto weapon:{"viewmodel_sniper_XM2010","viewmodel_sniper_PGM-Hecate2","viewmodel_sniper_Tactilite-T2_Silence","viewmodel_pistol_ColtPython","viewmodel_knife_M-9_Dual","viewmodel_knife_M-9_Dual_PBNC"}){
